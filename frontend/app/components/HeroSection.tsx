      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-primary mb-6 leading-tight">
          ...
          <span className="block text-transparent bg-clip-text bg-linear-to-r from-amber-600 via-orange-600 to-rose-600">
            Your Mineral Portfolio
          </span>
        </h1>

        <p className="text-xl text-secondary mb-12 max-w-2xl mx-auto leading-relaxed">
          Invest in tokenized commodity futures for oil, gold, and silver while learning the fundamentals of real-world asset tokenization. 
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search minerals: oil, gold, silver..."
              value={searchQuery}
